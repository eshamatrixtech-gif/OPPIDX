...
export default function WhatsAppConnect() {
  ...
  return (
    <div style={{
      ...
      <h1 style={{ fontSize: 28, fontWeight: 700, color: "#f5f5f7", marginBottom: 8 }}>
        Connect WhatsApp
      </h1>
      <p style={{ color: "rgba(245,245,247,0.5)", marginBottom: 40, fontSize: 15 }}>
        {status}
      </p>
      ...
      {qr ? (
        <div style={{
          ...
          boxShadow: "0 0 60px rgba(37,211,102,0.3)",
        }}>
