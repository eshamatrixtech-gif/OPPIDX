 ...
 *
 * headlineId is optional and only ever passed by the live /mayatara/pulse
...
export function PulseCard({ sym, category, title, source, timeLabel, url, headlineId }: PulseCardItem) {
